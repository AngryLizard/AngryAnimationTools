...
FRigUnit_ArmIK_Execute()
{
	...
	if (Context.State == EControlRigState::Update)
	{
		...
		else
		{
			...
			{
				Context.DrawInterface->DrawLine(FTransform::Identity, ShoulderLocation, ShoulderLocation + ArmDirection * 50.0f, FLinearColor::White, DebugSettings.Scale * 0.5f);
			}
			...
			if (DebugSettings.bEnabled)
			{
				...
				Context.DrawInterface->DrawLine(FTransform::Identity, ShoulderLocation, EllbowLocation, FLinearColor::Red, DebugSettings.Scale);
